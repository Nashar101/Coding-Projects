...
static int Major;
static struct semaphore sem;		/* Major number assigned to our device driver */
static int Device_Open = 0;	/* Is device open?  
				 * Used to prevent multiple access to device */
static char msg[BUF_LEN+2];	/* The msg the device will give when asked */
static int nummsgs = 0;
static int i = 0;
static int stpointer = 0;
static int edpointer = 0;
static int maxmessages = 1000;
